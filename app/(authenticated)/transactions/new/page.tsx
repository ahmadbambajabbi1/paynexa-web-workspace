  ...
  return (
    <div >
      <div className="mb-6">
        <Link
          href="/transactions"
          className="inline-flex items-center gap-2 text-sm font-medium text-gray-500 transition hover:text-primaryColorBlack"
        >
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm">
        <div className="border-b border-gray-100 bg-gray-50/70 p-5 sm:p-6">
          <p className="text-xs font-bold uppercase tracking-widest text-primaryColorBlack/70">Create transaction</p>
  ...
  return (
    <button
      ...
      className={`w-full rounded-xl border p-4 text-left transition ${props.active
        ? "border-primaryColorBlack bg-white shadow-sm ring-2 ring-primaryColorBlack/10"
        : "border-gray-200 bg-white/70 hover:border-gray-300"
        }`}
    >
      <span className={`mb-3 inline-flex h-10 w-10 items-center justify-center rounded-lg ${props.active ? "bg-primaryColorBlack text-white" : "bg-gray-100 text-gray-500"}`}>
